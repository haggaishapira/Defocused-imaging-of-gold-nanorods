function acquisition_settings_Callback(hObject, eventdata, handles)

    current_settings = handles.acquisition_settings;
    ...
    if ~isequal(answer,{})
        ...
        handles.acquisition_settings = cell2struct(answer, field_names, 1);
    end
