function analysis_settings_Callback(hObject, eventdata, handles)

    current_settings = handles.analysis_settings;
    ...
    if ~isequal(answer,{})
        ...
        handles.analysis_settings = cell2struct(answer, field_names, 1);
    end
