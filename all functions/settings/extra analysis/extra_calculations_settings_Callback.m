function extra_calculations_settings_Callback(hObject, eventdata, handles)

    current_settings = handles.extra_calculations_settings;
    ...
    if ~isequal(answer,{})
        ...
        handles.extra_calculations_settings = cell2struct(answer, field_names, 1);
    end
