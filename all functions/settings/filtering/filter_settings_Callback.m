function filter_settings_Callback(hObject, eventdata, handles)

    current_settings = handles.filter_settings;
    ...
    if ~isequal(answer,{})
        ...
        handles.filter_settings = cell2struct(answer, field_names, 1);
    end
