function finding_focus_settings_Callback(hObject, eventdata, handles)

    current_settings = handles.finding_focus_settings;
    ...
    if ~isequal(answer,{})
        ...
        handles.finding_focus_settings = cell2struct(answer, field_names, 1);
    end
