function microfluidics_settings_Callback(hObject, eventdata, handles)

    current_settings = handles.microfluidics_settings;
    field_names = fieldnames(current_settings);
    prompt = field_names;
    title = 'Microfluidics Settings';
    dimensions = [1 40];
    ...
    if ~isequal(answer,{})
        ...
        handles.microfluidics_settings = cell2struct(answer, field_names, 1);
    end
