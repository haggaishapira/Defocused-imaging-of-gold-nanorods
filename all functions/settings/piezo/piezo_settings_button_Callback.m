function piezo_settings_button_Callback(hObject, eventdata, handles)
    
    current_settings = handles.piezo_settings;
    field_names = fieldnames(current_settings);
    prompt = field_names;
    title = 'Piezo Settings';
    dimensions = [1 40];
    ...
    if ~isequal(answer,{})
        ...
        handles.piezo_settings = cell2struct(answer, field_names, 1);
    end
