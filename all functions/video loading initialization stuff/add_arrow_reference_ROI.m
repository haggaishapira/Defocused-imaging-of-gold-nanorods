function [arrow_main,arrow_right,arrow_left] = add_arrow_reference_ROI(handles)
    ...
    [x_main,y_main,x_right,y_right,x_left,y_left] = get_arrow_coordinates_ROI(ROI,0,pos,XLim,YLim);
